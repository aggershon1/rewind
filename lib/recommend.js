...
function buildPrompt(history, likedFeedback = []) {
...
async function getRecommendations(history, likedFeedback = []) {
  const prompt = buildPrompt(history, likedFeedback);
