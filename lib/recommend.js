...
function buildPrompt(history, likedFeedback = [], dislikedFeedback = []) {
...
${recentLines}${likedSection}${dislikedSection}
...
async function getRecommendations(history, likedFeedback = [], dislikedFeedback = []) {
  const prompt = buildPrompt(history, likedFeedback, dislikedFeedback);
